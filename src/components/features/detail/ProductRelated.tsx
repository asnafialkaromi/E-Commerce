...
import ProductCardSkeleton from "@/components/features/home/ProductCardSkeleton";
import { motion } from "framer-motion";
import ProductCard from "@/components/features/home/ProductCard";

export default function ProductRelated({ category }: { category: string }) {
  const limit = 15;
  ...
  const {
    ...
    isError,
    error,
  } = useInfiniteProducts(limit, category);
